...
export const EditProfileScreen = () => {
    ...
    const InputField = ({ label, value, onChangeText, placeholder }: { label: string, value: string, onChangeText: (text: string) => void, placeholder?: string }) => (
        ...
        >
            <ScrollView contentContainerStyle={styles.scrollContent}>
                <View style={styles.header}>
                    <TouchableOpacity onPress={handleImageSelection} style={styles.avatarWrapper}>
                        ...
                        <View style={styles.editIconContainer}>
                            <MaterialDesignIcons name="camera" size={20} color={COLORS.white} />
                        </View>
                    </TouchableOpacity>
                ...
                <View style={styles.form}>
                    ...
                    <View style={styles.inputContainer}>
                        ...
                        >
                            <Text style={[styles.dateText, !formData.dob && { color: COLORS.textSecondary }]}>
                                {formData.dob || 'Select Date of Birth'}
                            </Text>
                            <MaterialDesignIcons name="calendar" size={20} color={COLORS.primary} />
                        </TouchableOpacity>
                    </View>
