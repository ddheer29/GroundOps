    ...
    <ScrollView style={styles.container}>
      <View style={styles.section}>
        ...
        <Text style={styles.label}>
          Location: <Text style={styles.value}>{task.location}</Text>
        </Text>
        <Text style={styles.label}>
          Description: <Text style={styles.value}>{task.description}</Text>
        </Text>
        <Text style={styles.label}>
          Priority: <Text style={styles.value}>{task.priority}</Text>
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.buttonRow}>
          <TouchableOpacity
            ...
            style={[
              styles.statusBtn,
              task.status === 'Pending' && styles.activeBtn,
            ]}
          >
          ...
          <TouchableOpacity
            ...
            style={[
              styles.statusBtn,
              task.status === 'In Progress' && styles.activeBtn,
            ]}
          >
          ...
          <TouchableOpacity
            ...
            style={[
              styles.statusBtn,
              task.status === 'Completed' && styles.activeBtn,
            ]}
          >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.attachmentRow}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigate('Camera', { taskId: task._id })}
          >
